...
function ErrorCell({ className, message, children }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)(import_jsx_runtime6.Fragment, { children: [
    ...
    show && (0, import_react_dom.createPortal)(
      /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { className: "rsi-tooltip-fixed", style: { position: "fixed", top: pos.top, left: pos.left, transform: "translate(-50%, -100%)", zIndex: 9999 }, children: [
        /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("div", { className: "rsi-tooltip-inner", children: message }),
        /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("div", { className: "rsi-tooltip-arrow" })
      ] }),
      document.body
    )
  ] });
...
function ValidationStep({
  ...
  const columns = (0, import_react5.useMemo)(() => {
    return [import_react_data_grid.SelectColumn, ...fields.map((f) => ({
      key: f.key,
      name: f.label,
      editable: true,
      resizable: true,
      ...
      renderCell: ({ row }) => {
        ...
        if (!err) {
          return /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("div", { style: { width: "100%", height: "100%", display: "flex", alignItems: "center" }, children: value ?? "" });
        }
        return /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(ErrorCell, { className: `rsi-cell-${err.level}`, message: err.message, children: value ?? "" });
      }
    }))];
  }, [fields]);
